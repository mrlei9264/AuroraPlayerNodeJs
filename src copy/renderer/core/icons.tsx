...
const paths: Record<string, string> = {
  ...
  heart: 'M12 21s-7.5-4.6-10-9.2C.6 8.9 2.6 5.5 6 5.5c2 0 3.4 1 4 2.2.6-1.2 2-2.2 4-2.2 3.4 0 5.4 3.4 4 6.3C19.5 16.4 12 21 12 21z',
  heartFilled: 'M12 21S4.5 16.4 2 11.8C.6 8.9 2.6 5.5 6 5.5c2 0 3.4 1 4 2.2.6-1.2 2-2.2 4-2.2 3.4 0 5.4 3.4 4 6.3-2.5 4.6-10 9.2-10 9.2z',
